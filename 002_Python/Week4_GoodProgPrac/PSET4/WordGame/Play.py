...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while sum(hand.values()) != 0:
        # Display the hand
        print("Current Hand: ", end="", flush=True), displayHand(hand)
        # Ask user for input
    ...
    print("Game over. Total score is: " + str(score) + " points.")
...
def playGame(wordList):
    ...
    # remember the last hand
    lastHand = {}
    # load word list
    # wordList = loadWords() - MAYBE??????
    while True:
